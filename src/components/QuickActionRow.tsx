...
import { resolveBestLeadName, resolveLeadLocation } from "@/lib/lead-helpers";
...
export function QuickActionRow({
  ...
  const displayName = resolveBestLeadName(lead);
  const location = resolveLeadLocation(lead, tours, properties);
