...
export function BulkActionToolbar({ selectedCount, onBulkDelete, onBulkSetColor, onExportSelected }: BulkActionToolbarProps) {
  // For simplicity, provide a few preset colors
